...
import Navbar from '../src/Components/Event/Navbar';
...
import BookingForm from '../src/Components/UserBooking/BookingForm';
import PaymentForm from '../src/Components/Payment/PaymentForm'; 
import AdminPayment from '../src/Components/Payment/AdminPayment'
      ...
      <AuthProvider>
        ...
        <Route path="/bookingForm" element={ <ProtectedRoute> <UserBooking /> </ProtectedRoute>}/>
          <Route path="/dashboard2" element={ <ProtectedRoute role="admin"> <Dashboard2 /> </ProtectedRoute>}/>
           <Route path="/payment" element={ <ProtectedRoute role="admin"> <AdminPayment /> </ProtectedRoute>}/>
